...
new_createNeural(VcapInstance *a1, vcap::BuildConfig *a2) {
    __android_log_print(ANDROID_LOG_DEBUG, "iewoo",
                        "createNeural被hook了..%p..%d",
                        a2->model_file, a2->model_length);
    a2->model_length = 117;
    return orig_createNeural(a1, a2);
}

int
(*orig_createNeuralInner)(VcapInstance *a1, vcap::BuildConfig *a2, int a3, int a4, int a5, int a6);

int
new_createNeuralInner(VcapInstance *a1, vcap::BuildConfig *a2, int a3, int a4, int a5, int a6) {
    __android_log_print(ANDROID_LOG_DEBUG, "iewoo",
                        "createNeuralInner被hook了..%p..%d",
                        a2->model_file, a2->model_length);
    return orig_createNeuralInner(a1, a2, a3, a4, a5, a6);
}
...
//              (dobby_dummy_func_t *) &orig_createNeural);
    DobbyHook(DobbySymbolResolver(NULL,
                                  "_ZN12VcapInstance25_createNeuralNetworkInnerERN4vcap11BuildConfigEiiii"),
              (dobby_dummy_func_t) new_createNeuralInner,
              (dobby_dummy_func_t *) &orig_createNeuralInner);
}
